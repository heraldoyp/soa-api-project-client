      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
            ...
            <li><a href="/#mu-map">LOCATION</a></li>
            <li><a href="/#mu-contact">CONTACT</a></li> 
            <li><a href="/about">ABOUT THE API</a></li>                       
          </ul>                            
        </div><!--/.nav-collapse -->       
      </div>          
    </nav> 
      ...
      <div class="row">
        ...
        <div class="mu-footer-area">
          ...
          <div class="mu-footer-copyright">
            <p>&copy; Copyright <a rel="nofollow" href="http://markups.io">markups.io</a> X Heraldo Yusron (2001576892). All right reserved.</p>
            <p>In completing task of Service Oriented Architecture (COMP8036) Course</p>
          </div>         
        </div>
      </div>
      </div>
...
<script>
  import $ from  "@/assets/js/jquery2.min.js"
  
  // import "@/assets/js/bootstrap.js"
  // import "@/assets/js/slick.js"
  // import "@/assets/js/simple-animated-counter.js"
  ...
  export default {
    ...
    mounted() {
      ...
      // slick.setAttribute('src', './assets/js/slick.js')
      // document.head.appendChild(slick)

      // let simple_animated_counter = document.createElement('script')
      // simple_animated_counter.setAttribute('src', './assets/js/simple-animated-counter.js')
      // document.head.appendChild(simple_animated_counter)

      // let maginific_popup = document.createElement('script')
      // maginific_popup.setAttribute('src', './assets/js/jquery.maginific-popup.min.js')
      // document.head.appendChild(maginific_popup)

      // let bootstrap_datepicker = document.createElement('script')
      // bootstrap_datepicker.setAttribute('src', './assets/js/bootstrap-datepicker.js')
      // document.head.appendChild(bootstrap_datepicker)
